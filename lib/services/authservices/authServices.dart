...
class Authservices {
  static checkUserRegistration(BuildContext context) async {
  ...
  static signInWithGoogle(BuildContext context) async {
    ...
    await googleSignIn.initialize(serverClientId: "892507029691-tkj1u4at6qoesdb8ecbrnu1g5ed8hcnh.apps.googleusercontent.com");
