...
class Personalreviewpage extends StatefulWidget {
  const Personalreviewpage({super.key});
...
@override
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      await context.read<Getreportprovider>().addReviewReport(auth.currentUser!.uid);
    });
  }

  @override
  Widget build(BuildContext context) {
    List<PublicReviewModel> reports = context.watch<Getreportprovider>().reviewreports;
    return SafeArea(
      top: false,
      child: Scaffold(
